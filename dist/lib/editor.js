(() => {
  ...
  function codeFolding(config2) {
    let result = [foldState, baseTheme$13];
    if (config2)
  ...
  // unplugin-lezer:D:\Development\oiMUD\src\editor\syntax.grammar
  var parser2 = LRParser.deserialize({
    ...
    nodeNames: "\u26A0 LineComment Program Identifier String",
    maxTerm: 9,
    skippedNodes: [0, 1],
    repeatNodeCount: 1,
    tokenData: "$v~RZXYtYZt]^tpqtrs!V}!O#s!P!Q$X!Q![#s!c!}#s#R#S#s#T#o#s~ySW~XYtYZt]^tpqt~!YVOr!Vrs!os#O!V#O#P!t#P;'S!V;'S;=`#m<%lO!V~!tOS~~!wRO;'S!V;'S;=`#Q;=`O!V~#TWOr!Vrs!os#O!V#O#P!t#P;'S!V;'S;=`#m;=`<%l!V<%lO!V~#pP;=`<%l!V~#xTR~}!O#s!Q![#s!c!}#s#R#S#s#T#o#s~$[P!P!Q$_~$dSP~OY$_Z;'S$_;'S;=`$p<%lO$_~$sP;=`<%l$_",
    tokenizers: [0],
  ...
  var oiMUDLanguage = LRLanguage.define({
