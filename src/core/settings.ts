...
export let SettingList: any[] = [
    ...
    ['display.defaultMXPState', 0, SettingType.Boolean, false],
    ['customScrollbars', 0, SettingType.Boolean, false],
    ['saveDynamicProfiles', 0, SettingType.Boolean, false]
];
...
export class Settings {
    ...
    public static defaultValue(setting) {
        switch (setting) {
            ...
            case 'saveDynamicProfiles': return false;
            case 'display.showSplitButton': return true;
            case 'display.defaultMXPState': return false;
            case 'customScrollbars': return false;
